...
class StartOptions {
  const StartOptions({
    required this.androidCameraLensMode,
  ...
  ///
  /// Other platforms ignore this value.
  final AndroidCameraLensMode androidCameraLensMode;
  ...
  Map<String, Object?> toMap() {
    return <String, Object?>{
      'androidCameraLensMode': androidCameraLensMode.rawValue,
